...
TARGET_BUILDROOT_CONFIG=rockchip_rk3576_defconfig
...
BUILDROOT_FILES+=(device/friendlyelec/rk3576/disable-unnecessary-services)
BUILDROOT_FILES+=(device/friendlyelec/load-modules-service)
BUILDROOT_FILES+=(device/friendlyelec/rk3576/r8125)
BUILDROOT_FILES+=(device/friendlyelec/rk3576/rtl8822c-conf)
BUILDROOT_FILES+=(device/friendlyelec/rk3576/set-pulse-audio-default-output-to-hdmi0)
...
BUILDROOT_OUTDIR=output/rockchip_rk3576
TARGET_SD_RAW_FILENAME=buildroot_$(date +%Y%m%d)_rk3576_arm64_sd.img
TARGET_EFLASHER_RAW_FILENAME=buildroot_$(date +%Y%m%d)_rk3576_arm64_eflasher.img
